...
class Projectile:
    #classe gérant l'ensemble des projectiles qui soit du vaisseau ou des aliens
    ...
    def create(self):
        #fonction qui crée le projectile en forme de cercle

        return self.canvas.create_oval(self.x - 5, self.y - 5, self.x + 5, self.y + 5, fill='white')

    def bouger(self):
        #fonction qui gère les mouvements du projectile
    ...
    def toucher_bordure(self):
        #fonction qui gère l'interaction entre les bordures et les projectiles
